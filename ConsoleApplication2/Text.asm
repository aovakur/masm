...
hwnd dd 0
hInst dd 0
szTitleName db 'Лабороторная работа №4', 0
...
invoke MoveToEx, _hdc, 300, 300, 0; установка текущей позиции
invoke LineTo, _hdc, 300, 500; первая линия

invoke MoveToEx, _hdc, 300, 300, 0; установка текущей позиции
invoke LineTo, _hdc, 100, 500; вторая линия линия

invoke MoveToEx, _hdc, 200, 400, 0; установка текущей позиции
invoke LineTo, _hdc, 400, 400; третья линия
